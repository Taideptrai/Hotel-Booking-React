...
export default class Booknow extends Component {
    ...
    render() {
        console.log('day', this.state.startDate, this.state.endDate)
        const { getRoom } = this.context;
        const room = getRoom(this.state.slug);
        const { startDate, endDate } = this.state;
        const daysLeft = this.calculateDaysLeft(startDate, endDate)+1;
    if(!room){
        ...
        <div className="container my-5">
            <div className="row">
                <div className="col-md-10 mx-auto col-12 card shadow-lg border-0 p-4">
                    ...
                    <div className="row">
                        <div className="col-md-6 col-12">
                            <h6 className="font-weight-bolder">Number of days : {daysLeft > 0 ? daysLeft : <p style={{color:"red"}}>Please check your date again</p>}</h6>
                        ...
                        <div className="col-md-6 n-12">
                            ...
                            <h6 className="font-weight-bold">Total Price to be paid : <span className="text-primary">{ daysLeft >= 0 ? `$ ${daysLeft*price}`: <p style={{color:"red"}}>Please check your date again</p>}</span></h6>
                        </div>
                    </div>
